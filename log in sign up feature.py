 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "## Making full fledged authentication and enrollment system(sign up and log in)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "                    return \n",
    "                else:\n",
    "                    print('''Password must contain at least one uppercase, one lowercase ,one special character and one digit''')\n",
    "    else:\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "                            return 'Successful'\n",
    "                        else:\n",
    "                            print('''Password must contain at least one uppercase,one lowercase, special character and one digit''')\n",
    "                else:\n",
    "                    print('Incorrect OTP')\n",
    "                    continue\n",
    "        else:\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Password must contain at least one uppercase, one lowercase, one special character and one digit\n",
      "Create your password: renu@345\n",
